...
//    protected static String paxRunnerVmOption = DEBUG_VM_OPTION;
    ...
    public Option[] config()
    {
        ...
        Option[] base = options(
                ...
                wrappedBundle(mavenBundle("org.apache.commons", "commons-fileupload2-core").versionAsInProject()),
                wrappedBundle(mavenBundle("org.apache.commons", "commons-fileupload2-jakarta").versionAsInProject()),

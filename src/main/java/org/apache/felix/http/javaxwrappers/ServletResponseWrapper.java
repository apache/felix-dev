...
public class ServletResponseWrapper implements javax.servlet.ServletResponse {
    ...
    public static javax.servlet.ServletResponse getWrapper(final ServletResponse r) {
        if ( r instanceof org.apache.felix.http.jakartawrappers.ServletResponseWrapper) {
            return ((org.apache.felix.http.jakartawrappers.ServletResponseWrapper)r).getResponse();
        }

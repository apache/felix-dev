...
public class ServletWrapper implements Servlet {
    ...
    public static Servlet getRegisteredServlet(final javax.servlet.Servlet s) {
        if ( s instanceof org.apache.felix.http.javaxwrappers.ServletWrapper ) {
            return ((org.apache.felix.http.javaxwrappers.ServletWrapper)s).getServlet();
        }
    ...
    public void init(final ServletConfig config) throws ServletException {
        try {
            servlet.init(new org.apache.felix.http.javaxwrappers.ServletConfigWrapper(config));

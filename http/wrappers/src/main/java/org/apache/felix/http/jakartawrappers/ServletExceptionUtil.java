...
public class ServletExceptionUtil {
    ...
    public static ServletException getServletException(@NotNull final javax.servlet.ServletException e) {
        if ( e instanceof org.apache.felix.http.javaxwrappers.ServletExceptionWrapper) {
            return ((org.apache.felix.http.javaxwrappers.ServletExceptionWrapper)e).getException();
        }

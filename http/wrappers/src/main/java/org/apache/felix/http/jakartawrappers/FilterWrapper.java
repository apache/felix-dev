...
public class FilterWrapper implements Filter {
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        try {
            this.filter.init(new org.apache.felix.http.javaxwrappers.FilterConfigWrapper(filterConfig));
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            this.filter.doFilter(org.apache.felix.http.javaxwrappers.ServletRequestWrapper.getWrapper(request),
                    ...
                    new org.apache.felix.http.javaxwrappers.FilterChainWrapper(chain));
        } catch (final javax.servlet.ServletException e) {
            throw ServletExceptionUtil.getServletException(e);
        }
    }

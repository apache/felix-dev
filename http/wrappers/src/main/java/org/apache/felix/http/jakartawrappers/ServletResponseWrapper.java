...
public class ServletResponseWrapper implements ServletResponse {
    ...
    public static ServletResponse getWrapper(final javax.servlet.ServletResponse r) {
        if ( r instanceof org.apache.felix.http.javaxwrappers.ServletResponseWrapper) {
            return ((org.apache.felix.http.javaxwrappers.ServletResponseWrapper)r).getResponse();
        }

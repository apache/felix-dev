...
| `org.apache.felix.https.trustAllCertificates` | Flag to trust all SSL certificates. This can be used for development purposes or if the certificates are already validated before ending up in Jetty. The default is `false`.                                                    |
